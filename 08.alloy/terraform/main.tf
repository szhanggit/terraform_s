...
resource "aws_security_group" "dotnet-app-sg" {
    ...
    tags = {
        Name = "${var.env_prefix}-dotnet-app-sg"
    }
}
...
resource "aws_security_group" "python-app-sg" {
    ...
    tags = {
        Name = "${var.env_prefix}-python-app-sg"
    }
}
...
output "dotnet_app_public_ip" {
    value = aws_instance.dotnet-app.public_ip
}

output "python_app_public_ip" {
    value = aws_instance.python-app.public_ip
}
...
resource "aws_instance" "dotnet-app" {
